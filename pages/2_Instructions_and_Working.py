...
with tab1:
    ...
    st.write("3. Switch to the Grades-Score tab, "
             "Here you can see the minimum marks to score in SEE to get respective grades.")
...
with tab2:
    ...
    st.write("Grade Point Average (CGPA), both of which are important performance indices of the student. "
             "SGPA is equal to the sum of all the total points earned by the student in a given semester "
             "divided by the number of credits registered by the student in that semester. "
             "CGPA gives the sum of all the total points earned in all the previous semesters and the current semester "
             "divided by the number of credits registered in all these semesters.")
    st.markdown(r"""
    ...
    st.latex(r"CGPA = \frac{Sum \ of \ all \ SGPA}{Total \ Credits \ earned}")
